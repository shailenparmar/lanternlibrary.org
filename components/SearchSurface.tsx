...
const SAMPLE_QUERIES = [
  ...
  "Mornings feel heavy",
  "Things feel flatter than they used to",
  "Going through the motions",
  "Feeling far from people",
  "Looking for someone who gets it",
  "Want to hear from people who've been here",
  "Caught in loops I can't break",
  "Food has gotten complicated",
  "Changes in my body I didn't choose",
  "Living with pain that lingers",
  "Adjusting after something changed",
  "In the long middle of something hard",
